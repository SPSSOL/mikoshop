...
class DiscountsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create discount" do
    assert_difference("Discount.count") do
      post discounts_url, params: { discount: { code: @discount.code, discount_percent: @discount.discount_percent, valid_until: @discount.valid_until } }
    end
  ...
  test "should update discount" do
    patch discount_url(@discount), params: { discount: { code: @discount.code, discount_percent: @discount.discount_percent, valid_until: @discount.valid_until } }
