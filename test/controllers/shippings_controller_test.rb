...
class ShippingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shipping" do
    assert_difference("Shipping.count") do
      post shippings_url, params: { shipping: { created_at: @shipping.created_at, order_id: @shipping.order_id, pickup_location: @shipping.pickup_location, status: @shipping.status } }
    end
  ...
  test "should update shipping" do
    patch shipping_url(@shipping), params: { shipping: { created_at: @shipping.created_at, order_id: @shipping.order_id, pickup_location: @shipping.pickup_location, status: @shipping.status } }
